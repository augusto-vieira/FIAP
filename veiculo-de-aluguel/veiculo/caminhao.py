...
class Caminhao(Veiculo):
    def __init__(self, marca, modelo, ano, diaria, capacidade_de_carga):
        ...
        self._carga = capacidade_de_carga  # Capacidade de carga em quilogramas

    def informacao(self):
        base_info = super().informacao()  # Obtém informações da classe pai
        return f"{base_info}, Capacidade de carga: {self._carga}kg"  # Retorna informações completas com a capacidade de carga
