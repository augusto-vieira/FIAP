...
class Carro(Veiculo):
    def __init__(self, marca, modelo, ano, diaria, portas):
        ...
        self._portas = portas  # Atributo que armazena o número de portas do carro

    def informacao(self):
        base_info = super().informacao()  # Obtém as informações básicas da classe pai
        return f"{base_info}, Portas: {self._portas}"  # Adiciona o número de portas às informações
